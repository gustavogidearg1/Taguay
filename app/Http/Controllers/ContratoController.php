...
class ContratoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('contratos.index', compact('contratos', 'q', 'perPage'));
    }
    ...
    public function create()
    {
        ...
        return view('contratos.create', compact(
            'campanias','cultivos','monedas','organizaciones',
            'defaultVendedor',
            'optCaracteristica','optFormacion','optCondicionPrecio','optCondicionPago',
            'optListaGrano','optDestino','optFormato','optDisponibleTipo',
            'defaultMonedaId'
        ));
    }
    ...
    public function edit(Contrato $contrato)
    {
        ...
        return view('contratos.edit', compact(
            'contrato','campanias','cultivos','monedas','organizaciones',
            'defaultVendedor',
            'optCaracteristica','optFormacion','optCondicionPrecio','optCondicionPago',
            'optListaGrano','optDestino','optFormato','optDisponibleTipo'
        ));
    ...
    private function sendContratoMail(Contrato $contrato, string $action): void
    {
        ...
        $to = env('LLUVIAS_NOTIFY_TO', auth()->user()->email);
        $cc = env('CONTRATOS_MAIL_CC');
