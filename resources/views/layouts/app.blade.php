...
<head>
    ...
    <style>
        ...
        /* Dropdown ABM: que el accordion se vea prolijo */
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            ...
                            @role('admin')
                                <li class="nav-item dropdown" id="abmDropdown" data-bs-auto-close="false">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                        ABM
                                    </a>

                                    <div class="dropdown-menu p-2" style="min-width: 340px;">
                                        <div class="accordion accordion-flush" id="abmAccordion">

                                            {{-- AGRÍCOLA --}}
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="abmAgricolaHead">
                                                    <button class="accordion-button collapsed py-2" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#abmAgricola"
                                                        aria-expanded="false" aria-controls="abmAgricola">
                                                        <i class="fa-solid fa-seedling me-2"></i> Agrícola
                                                    </button>
                                                </h2>
                                                <div id="abmAgricola" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body py-2 px-0">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('cultivos.index') }}">
                                                            <i class="fa-solid fa-seedling me-2"></i> Cultivo
                                                        </a>
                                            ...
                                            {{-- COMERCIALES --}}
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="abmComercialHead">
                                                    <button class="accordion-button collapsed py-2" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#abmComercial"
                                                        aria-expanded="false" aria-controls="abmComercial">
                                                        <i class="fa-solid fa-handshake me-2"></i> Comerciales
                                                    </button>
                                                </h2>
                                                <div id="abmComercial" class="accordion-collapse collapse"
                                                    aria-labelledby="abmComercialHead" data-bs-parent="#abmAccordion">
                                                    <div class="accordion-body py-2 px-0">
                                                        <a class="dropdown-item" href="{{ route('monedas.index') }}">
                                                            <i class="fa-solid fa-coins me-2"></i> Moneda
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('organizaciones.index') }}">
                                                            <i class="fa-solid fa-sitemap me-2"></i> Organizaciones
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('tipo-productos.index') }}">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('productos.index') }}">
                                                            <i class="fa-solid fa-boxes-stacked me-2"></i> Producto
                                                        </a>
                                                        <a class="dropdown-item" href="{{ route('condicion-pagos.index') }}">
                                                            <i class="fa-solid fa-file-invoice-dollar me-2"></i> Cond. Pago
                                                        </a>

                                                        <a class="dropdown-item" href="{{ route('financieras.index') }}">
                                            ...
                                            {{-- ADMIN --}}
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="abmAdminHead">
                                                    <button class="accordion-button collapsed py-2" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#abmAdmin"
                                                        aria-expanded="false" aria-controls="abmAdmin">
                                                        <i class="fa-solid fa-user-shield me-2"></i> Admin
                                                    </button>
                                                </h2>
                                                <div id="abmAdmin" class="accordion-collapse collapse"
                                                    aria-labelledby="abmAdminHead" data-bs-parent="#abmAccordion">
                                                    <div class="accordion-body py-2 px-0">
    ...
    {{-- ✅ Evita cierres raros si haces click dentro del accordion --}}
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const ddEl = document.getElementById('abmDropdown');
            if (!ddEl) return;

            // Evita que clicks dentro del menú cierren el dropdown
            ...
            // En algunos casos Bootstrap intenta cerrar igual; lo bloqueamos si el click fue dentro del menú
            ddEl.addEventListener('hide.bs.dropdown', (event) => {
                const ae = document.activeElement;
                if (menu && menu.contains(ae)) {
